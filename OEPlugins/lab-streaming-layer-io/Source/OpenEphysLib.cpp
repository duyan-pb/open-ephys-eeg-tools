...
#include "Inlet/LSLInletThread.h"
#include "Outlet/LSLOutlet.h"
...
extern "C" EXPORT int getPluginInfo (int index, Plugin::PluginInfo* info)
{
    switch (index)
    {
        // LSL Inlet - Data source that receives LSL streams
        case 0:
        ...
        // LSL Outlet - Sink that sends data to LSL
        case 1:
            info->type = Plugin::Type::PROCESSOR;
            info->processor.name = "LSL Outlet";
            info->processor.type = Plugin::Processor::SINK;
            info->processor.creator = &createProcessor<LSLOutlet>;
            break;
