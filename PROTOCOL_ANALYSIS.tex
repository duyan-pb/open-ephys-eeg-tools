...
\newcommand{\freewin}{\texorpdfstring{\textcolor{okgreen}{\ding{51}\,Free Win}}{(Free Win)}}
\newcommand{\implemented}{\texorpdfstring{\textcolor{codeblue}{\ding{51}\,Implemented}}{(Implemented)}}
...
\begin{figure}[H]
\centering
\begin{bytefield}[bitwidth=0.88em, bitheight=2.5em]{33}
...
\begin{figure}[H]
\centering
\begin{bytefield}[bitwidth=0.60em, bitheight=2.5em]{56}
...
\begin{figure}[H]
\centering
\begin{bytefield}[bitwidth=1.2em, bitheight=2.5em]{26}
...
\begin{figure}[H]
\centering
\begin{bytefield}[bitwidth=0.62em, bitheight=2.5em]{54}
...
\centering
\small
\begin{tabular}{l R{1.2cm} R{1.2cm} R{1.5cm} R{1.6cm} R{1.5cm}}
\toprule
...
\textbf{Trade-off}: Higher BER, USB-serial IC compatibility limits, cable quality critical at $>$3\,Mbaud.
Low priority --- current 130\,$\mu$s is small vs.\ 1\,ms sample period.
...
\tiny
\begin{longtable}{l C{1.5cm} C{1.3cm} C{1.3cm} C{1.3cm} C{1.3cm} C{1.5cm} C{1.5cm}}
...
\begin{longtable}{l C{1.6cm} C{1.3cm} C{1.3cm} C{1.3cm} C{1.3cm} C{1.5cm} C{1.5cm}}
