...
\textbf{Trade-off}: Higher BER, USB-serial IC compatibility limits,
cable quality critical at $>$3\,Mbaud.
...
A common mistake in serial bandwidth calculations is using
\texttt{baud\_rate\,/\,8} instead of \texttt{baud\_rate\,/\,10}.
