...
\begin{bytefield}[bitwidth=0.82em, bitheight=2.5em]{33}
    ...
    \bitbox{1}{\scalebox{.7}{\tiny\texttt{0xA0}}\\\scalebox{.7}{\tiny START}} &
    \bitbox{1}{\scalebox{.7}{\tiny SEQ}} &
    \bitbox{3}{\tiny Ch1} &
    \bitbox{3}{\tiny Ch2} &
    \bitbox{3}{\tiny Ch3} &
    \bitbox{3}{\tiny Ch4} &
    ...
    \bitbox{1}{\scalebox{.7}{\tiny\texttt{0xCn}}\\\scalebox{.7}{\tiny END}}
\end{bytefield}
...
\begin{bytefield}[bitwidth=0.55em, bitheight=2.5em]{56}
    ...
    \bitbox{2}{\scalebox{.65}{\tiny START}\\\scalebox{.6}{\tiny A5\,5A}} &
    ...
    \bitbox{1}{\scalebox{.6}{\tiny CHK}} &
    \bitbox{2}{\scalebox{.65}{\tiny END}\\\scalebox{.6}{\tiny C0\,C0}}
\end{bytefield}
...
\begin{bytefield}[bitwidth=1.1em, bitheight=2.5em]{26}
    ...
    \bitbox{1}{\scalebox{.7}{\tiny TYPE}\\\scalebox{.7}{\hexval{00}}} &
...
\begin{bytefield}[bitwidth=0.9em, bitheight=2.5em]{32}
    ...
    \bitbox{2}{\scalebox{.8}{\tiny START}} &
    \bitbox{1}{\scalebox{.7}{\tiny TYPE}\\\scalebox{.7}{\hexval{01}}} &
    \bitbox{1}{\scalebox{.8}{\tiny SEQ}} &
    \bitbox{4}{\tiny TS} &
    \bitbox{15}{\tiny EEG (5ch $\times$ 3\,B)} &
    \bitbox{6}{\tiny ACCEL\\X,Y,Z} &
    \bitbox{1}{\scalebox{.7}{\tiny CHK}} &
    \bitbox{2}{\scalebox{.8}{\tiny END}}
\end{bytefield}
...
\begin{bytefield}[bitwidth=0.56em, bitheight=2.5em]{54}
    ...
    \bitbox{1}{\scalebox{.6}{\tiny T}\\\scalebox{.55}{\hexval{06}}} &
...
\centering
\small
\begin{tabularx}{\textwidth}{|l|C{2.8cm}|C{2.8cm}|>{\raggedright\arraybackslash}C{2.8cm}|}
\hline
