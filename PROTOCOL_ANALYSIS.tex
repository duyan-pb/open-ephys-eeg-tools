...
\begin{bytefield}[bitwidth=0.82em, bitheight=2.5em]{33}
    ...
    \bitbox{1}{\scalebox{.45}{\tiny\texttt{0xA0}}\\\scalebox{.5}{\tiny START}} &
...
\begin{bytefield}[bitwidth=0.55em, bitheight=2.5em]{56}
    ...
    \bitbox{2}{\scalebox{.5}{\tiny END}\\\scalebox{.45}{\tiny C0\,C0}}
\end{bytefield}
...
\begin{bytefield}[bitwidth=0.56em, bitheight=2.5em]{54}
    ...
    \bitbox{1}{\scalebox{.4}{\tiny T}\\\scalebox{.35}{\hexval{06}}} &
...
\centering
\small
\begin{tabularx}{\textwidth}{|l|>{\raggedright\arraybackslash}C{2.8cm}|>{\raggedright\arraybackslash}C{2.8cm}|>{\raggedright\arraybackslash}C{2.8cm}|}
\hline
